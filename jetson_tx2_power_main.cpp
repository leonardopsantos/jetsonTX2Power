    ...
    while ((c = getopt(argc, argv, "hf:c:t:")) != -1) {
        ...
        case 'h':
            cout
                    ...
                    << endl;
            cout
                    << "The option \'-f <csv file>\' writes a CSV file. If the file already exists the values will be appended at the end."
                    << endl;
            cout
                    << "The option \'-c <number>\' loops \'number\' times, can be used with -t."
                    << endl;
            cout
                    << "The option \'-t <period>\' takes a sample every \'period\' miliseconds, can be used with -c."
                    << endl;
            return 0;
        case '?':
